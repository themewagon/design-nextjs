        ...
        <div className="mx-auto max-w-2xl py-40 px-4s sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="bg-image-what">
                ...
                <div className="lg:relative">
                    <Image src={bp('/assets/clientsay/avatars.png')} alt="avatar-image" width={1061} height={733} className="hidden lg:block" />

                    <span className="lg:absolute lg:bottom-40 lg:left-80">
                        <Image src={bp('/assets/clientsay/user.png')} alt="user-image" width={168} height={168} className="mx-auto pt-10 lg:pb-10" />
